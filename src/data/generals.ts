      ...
      },
      {
        ...
        skills: [
          ...
          },
          {
            name: "息兵",
            description:
              "其他角色于出牌阶段使用首张黑色【杀】或黑色普通锦囊牌指定唯一目标后，你可以令其将手牌摸至体力值且本回合不能使用手牌，若你于其武将牌均明置，你可以暗置你与其各一张武将牌且本回合不能再明置之。",
            standardizedSkill: {
              description:
    ...
    versions: [
      {
        ...
        skills: [
          ...
          // },
          {
            name: "襄举",
            description:
              "准备阶段，你可以对所有其他角色发起议事，若结果为：红色，你跳过摸牌阶段，并视为对你和红色意见角色使用【联军盛宴】；黑色，你跳过出牌阶段，并判定，对你和议事牌点数不大于判定结果的角色造成1点冰属性伤害。",
            keywords: ["议事", "冰属性伤害"],
            standardizedSkill: {
              description:
                // 用“议事”关键字描述
                "准备阶段，你可以令所有有手牌的其他角色同时展示一张手牌▶若以此法展示的红色牌多于黑色牌，你跳过摸牌阶段▷你对你和所有以此法展示红色牌的其他角色使用一张无对应实体牌的【联军盛宴】（你因执行此牌的效果而摸牌或回复的总数为以此法展示红色牌的角色数）。若以此法展示的黑色牌多于红色牌，你跳过出牌阶段▷你判定，对你和以此法展示的牌点数不大于判定结果的角色造成1点冰属性伤害。",
            ...
            standardizedSkill: [
              {
                ...
                index: 1,
                description:
                  "回合开始时或你明置此武将牌时，若你未确定势力，你可以不公开你的真实势力，你声明任意未以此法声明过的势力，直到你即将进行死亡结算，你视为此势力角色▶你变更副将（以此法失去的副将牌不需要翻至正面朝上，被称为“初始副将”），你失去“悍跳①”并获得“悍跳②”。",
                type: "Trigger",
                timing: ["回合开始时", "明置武将牌时"],
              },
              {
