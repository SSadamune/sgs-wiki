        ...
        skills: [
          ...
          // },
          {
            ...
            standardizedSkill: {
              description:
                // 用“议事”关键字描述
                "准备阶段，你可以令所有有手牌的其他角色同时展示一张手牌▶若以此法展示的红色牌多于黑色牌，你跳过摸牌阶段▷你对你和所有以此法展示红色牌的其他角色使用一张无对应实体牌的【联军盛宴】（你因执行此牌的效果而摸牌或回复的总数为以此法展示红色牌的角色数）。若以此法展示的黑色牌多于红色牌，你跳过出牌阶段▷你判定，你对你和以此法展示的牌点数不大于判定结果的角色造成1点冰属性伤害。",
